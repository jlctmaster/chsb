...
(
	...
	direccion varchar(255) not null,
	telefono_local varchar(10),
	telefono_movil varchar(10),
  	profesion varchar(60),
  	grado_instruccion varchar(80),
...
CREATE TABLE educacion.tproceso_inscripcion (
	...
	tiene_hermanos char(1) NOT NULL default 'N',
 	...
 	que_anio varchar(40) default null,
 	...
 	integracion_electricidad char(1) not null default 'N',
 	integracion_albanileria char(1) not null default 'N',
 	integracion_peluqueria char(1) not null default 'N',
 	integracion_ambientacion char(1) not null default 'N',
 	integracion_manualidades char(1) not null default 'N',
 	integracion_bisuteria char(1) not null default 'N',
 	otra_integracion char(1) not null default 'N',
...
(
	nombre_usuario char(10) not null,
	cedula_persona char(10) not null,
