<?php
	...
	$tituloReporte = "Listado de Años Academicos";
	$titulosColumnas = array('Código', 'Año', 'Estatus');
	...
	header('Content-Disposition: attachment;filename="Listado Años academicos.xlsx"');
