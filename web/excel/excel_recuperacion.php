<?php
  ...
  WHERE r.esrecuperacion='Y'";
	...
	$tituloReporte = "Listado de las Recuperaciones de Bienes";
	$titulosColumnas = array('Código', 'Fecha', 'Responsable', 'Ubicación Origen', 'Bien a Recuperar', 'Cantidad a Recuperar', 'Item', 'Cantidad', 'Ubicación', 'Estatus');
	...
	$objPHPExcel->getActiveSheet()->setTitle('Listado Recuperaciones');
	...
	header('Content-Disposition: attachment;filename="Listado Recuperacion.xlsx"');
