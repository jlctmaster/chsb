<?php
	...
	$tituloReporte = "Listado de las Área";
	$titulosColumnas = array('Código', 'Área', 'Departamento', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_area'])
		->setCellValue('B'.$i, $row['area'])
		->setCellValue('C'.$i, $row['departamento'])
	...
	$objPHPExcel->getActiveSheet()->setTitle('Área');
	...
	header('Content-Disposition: attachment;filename="Listado Áreas.xlsx"');
