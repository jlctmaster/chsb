<?php
	...
	$titulosColumnas = array('Ubicación', 'Item', 'Existencia');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['ubicacion'])
		->setCellValue('B'.$i, $row['item'])
		->setCellValue('C'.$i, $row['existencia']);
		$i++;
	}
	...
	$objPHPExcel->getActiveSheet()->setTitle('Inventario de Bienes');
	...
	header('Content-Disposition: attachment;filename="Inventario Bienes.xlsx"');
