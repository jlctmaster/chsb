<?php
	...
	$sql = "SELECT rif_organizacion, nombre, direccion, telefono, 
                 CASE tipo_organizacion when '1' then 'PÚBLICA' when '2' then 'PRIVADA' when '3' then 'GUBERNAMENTAL' else 'OTRAS' end as tipo, 
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['rif_organizacion'])
	...
	$objPHPExcel->getActiveSheet()->setTitle('Listado Organizaciones');
	...
	header('Content-Disposition: attachment;filename="Listado Organizaciones.xlsx"');
