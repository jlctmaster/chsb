<?php
	...
	$tituloReporte = "Listado de los Departamentos";
	$titulosColumnas = array('Código', 'Departamento', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_departamento'])
	...
	header('Content-Disposition: attachment;filename="Listado Departamento.xlsx"');
