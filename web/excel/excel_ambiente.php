<?php
	...
	$tituloReporte = "Listado de los Ambientes";
	$titulosColumnas = array('Código', 'Ambiente', 'Tipo Ambiente', 'Estatus');
	...
	$objPHPExcel->getActiveSheet()->setTitle('Ambiente');
	...
	header('Content-Disposition: attachment;filename="Listado Ambiente.xlsx"');
