<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT descripcion, es_usuariosistema, estatus, 
					CASE es_usuariosistema when 'Y' then 'SI' when 'N' then 'NO' end as usuario, 
	...
	$objPHPExcel->getActiveSheet()->setTitle('Tipo Personas');
	...
	header('Content-Disposition: attachment;filename="Listado Tipo Personas.xlsx"');
