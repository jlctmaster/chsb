<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT codigo_pais, descripcion, (CASE estatus WHEN '1' THEN 'ACTIVO' ELSE 'DESACTIVADO' END) AS estatus FROM general.tpais ORDER BY codigo_pais ASC";
	...
	$tituloReporte = "Listado de los paises";
