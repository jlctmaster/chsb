<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT codigo_tipo_bien, descripcion, (CASE estatus WHEN '1' THEN 'ACTIVO' ELSE 'DESACTIVADO' END) AS estatus FROM bienes_nacionales.ttipo_bien ORDER BY codigo_tipo_bien ASC";
	...
	$tituloReporte = "Listado de los Tipos de Bienes";
	$titulosColumnas = array('Código', 'Tipos de Bienes', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_tipo_bien'])
	...
	$objPHPExcel->getActiveSheet()->setTitle('TipoBienes');
