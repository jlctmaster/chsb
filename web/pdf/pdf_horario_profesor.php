<?php
  ...
  class clsFpdf extends FPDF {
    ...
    public function Header(){
      ...
      $this->Cell(0,6,utf8_encode("REPÚBLICA BOLIVARIANA DE VENEZUELA"),0,1,"C");
      $this->Cell(0,6,utf8_encode("MINISTERIO DEL PODER POPULAR PARA LA EDUCACIÓN SUPERIOR"),0,1,"C");
      $this->SetFont('Arial','B',10);  
      $this->Cell(0,6,utf8_encode("UNIVERSIDAD DEPORTIVA DEL SUR"),0,1,"C");
      $this->SetFont('Arial','',10); 
      $this->Cell(0,6,utf8_encode("SECRETARÍA GENERAL"),0,1,"C");
      $this->SetFont('Arial','B',10);  
      $this->Cell(0,6,utf8_encode("DIRECCIÓN DE CONTROL DE ESTUDIOS"),0,1,"C");
      $this->Ln(8); */
      //Título
      $this->Cell(10);
      $this->SetFont('Arial','B',10);
      $this->Cell(0,7,"PROFESOR(A): ".$_SESSION['datos']['nombre'][0]." ".$_SESSION['datos']['apellido'][0],0,0,"L");
      $this->SetFont('Arial','B',18);
      $this->Cell(-260,7,"* HORARIO *",0,1,"C");  
      $this->SetFont('Arial','B',10);
      $this->Cell(10);		
      $this->Cell(0,7,utf8_encode("CÉDULA: ".$_SESSION['datos']['cedula'][0]),0,1,"L"); 
      $this->Ln(5);			
