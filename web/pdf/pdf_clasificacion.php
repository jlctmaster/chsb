<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE LAS CLASIFICACIONES',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*4,$altura,'CLASIFICACIÓN',1,0,'L',$color_fondo);
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT *,(CASE estatus WHEN '1' THEN 'ACTIVO' ELSE 'DESACTIVADO' END) AS estatus from biblioteca.tclasificacion";
   $i=-1;
  $data=$pgsql->Ejecutar($sql);
    if($pgsql->Total_Filas($data)!=0){
         ...
         $lobjPdf->Row(array(
         ucwords($tperfil['codigo_clasificacion']),
