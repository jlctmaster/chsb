<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE LOS LAPSOS ACADÉMICOS',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*2,$altura,'LAPSO',1,0,'L',$color_fondo);
      $this->Cell($anchura*2,$altura,'AÑO',1,0,'L',$color_fondo);
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,20,20,26));
  $pgsql=new Conexion();
    $sql="SELECT l.codigo_lapso,l.lapso, a.ano, 
(CASE l.estatus WHEN '1' THEN 'ACTIVO' ELSE 'DESACTIVADO' END) AS estatus FROM educacion.tlapso l
INNER JOIN educacion.tano_academico AS a ON l.codigo_ano_academico = a.codigo_ano_academico";
   $i=-1;
