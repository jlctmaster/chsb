...
class clsFpdf extends FPDF {
  ...
  public function Header(){
    ...
    $this->Cell(0,6,'LISTADO DE LAS ASIGNACIONES',0,1,"C");
    $this->Ln(8);
    ...
    $this->Cell($anchura*4,$altura,'FECHA ADQUISICIÓN',1,0,'C',$color_fondo); 
    $this->Cell($anchura*6,$altura,'RESPONSABLE',1,0,'C',$color_fondo);
    $this->Cell($anchura*4+5,$altura,'ITEM',1,0,'C',$color_fondo);
...
if($pgsql->Total_Filas($data)!=0){
  ...
  while($tperfil=$pgsql->Respuesta($data)){
    $lobjPdf->Row(array(
    ucwords($tperfil['codigo_asignacion']),
    ucwords($tperfil['fecha_asignacion']),
