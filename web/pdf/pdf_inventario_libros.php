...
require_once("../librerias/fpdf/fpdf.php");
  ...
  class clsFpdf extends FPDF {
   ...
   //Cabecera de página
	...
	$this->Cell(0,6,'INVENTARIO DE BIBLIOTECA',0,1,"C");
	$this->Ln(8);
	...
	$this->SetFillColor(0,0,140); 
		...
		$this->Cell($avnzar);
		$this->Cell($anchura*4+5,$altura,'UBICACIÓN',1,0,'C',$color_fondo); 
		$this->Cell($anchura*4+5,$altura,'ITEM',1,0,'C',$color_fondo);
		$this->Cell($anchura*3,$altura,'EXISTENCIA',1,1,'C',$color_fondo); 
