...
require_once("../librerias/fpdf/fpdf.php");
  ...
  public function Header(){
    ...
    $this->Cell(68);
    $this->Cell(69,5,'CARTA DE MOROSIDAD',0,0);
    $this->Ln(13);
    ...
    $this->SetFont('Arial','B',12);
    $this->Cell(8);
    $this->Cell(14,5,'Atención:',0,1);
    $this->Cell(5);
    $this->Ln(5);
    $this->Cell(5);
    $this->Cell(80,5,'__________________________________',0,1);
    $this->Ln(1);
     ...
     $this->SetFillColor(0,0,140); 
         ...
         $this->SetTextColor(0,0,0);
                $this->Cell($avnzar);
      $this->Cell($anchura+7,$altura,'LIBRO',1,0,'C',$color_fondo); 
      $this->Cell($anchura*3,$altura,'CANTIDAD',1,0,'C',$color_fondo);
      $this->Cell($anchura*4,$altura,'FECHA DE PRÉSTAMO',1,0,'C',$color_fondo);
      $this->Cell($anchura*4,$altura,'FECHA DE VENCIMIENTO',1,1,'C',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT  l.titulo AS ejemplar,da.cantidad,TO_CHAR(b.fecha_salida,'DD/MM/YYYY') AS fecha_salida, 
    TO_CHAR(b.fecha_entrada,'DD/MM/YYYY') AS fecha_entrada
