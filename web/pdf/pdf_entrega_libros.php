...
class clsFpdf extends FPDF {
  ...
  public function Header(){
    ...
    $this->Cell($anchura*7,$altura,'EJEMPLAR',1,0,'C',$color_fondo);
    $this->Cell($anchura*4,$altura,'FECHA ENTRADA',1,0,'C',$color_fondo);
...
if($pgsql->Total_Filas($data)!=0){
 ...
 while($entrega=$pgsql->Respuesta($data)){
    $lobjPdf->Row(array($entrega['responsable'],
    $entrega['ejemplar'],
    $entrega['fecha_entrada'],
    $entrega['cantidad']));
