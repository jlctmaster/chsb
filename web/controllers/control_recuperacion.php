...
if($lOpt=='BuscarItems'){
  echo $mov_inventario->BuscarItems($_POST['codigo_ubicacion']);
...
if($lOpt=='BuscarConfiguracion'){
  echo $mov_inventario->BuscarConfiguracion($_POST['codigo_bien'],$_POST['cantidad']);
  unset($mov_inventario);
}
?>