...
if($lOpt=='Registrar'){
  ...
  if($confirmacion==1){
    ...
    header("Location: ../view/menu_principal.php?adquisicion_libros&Opt=2");
  }else{
...
if($lOpt=='Modificar'){
  ...
  if($confirmacion==1){
    ...
    header("Location: ../view/menu_principal.php?adquisicion_libros&Opt=3&codigo_adquisicion=".$adquisicion->codigo_adquisicion());
  }else{
    $adquisicion->Transaccion('cancelado');
