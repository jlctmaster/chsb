<fieldset>
	<legend><center>Reporte: RECONSTRUCCIÓN DE BIENES</center></legend>
	<div id="paginador" class="enjoy-css">
		<div class="container">
			<form class="form-horizontal" action="../pdf/pdf_reconstruccion_bienes.php"  method="post" id="form1">
...
function init(){
	$('#btnGuardar').click(function(){
		var send=true;
		if($('#fecha_inicio').val()==""){
			alert("¡Debe ingresar la fecha desde la cual desea ver la reconstrucción de bienes!");
			send=false;
		}
		
		if($('#fecha_fin').val()==""){
			alert("¡Debe ingresar la fecha hasta donde desea ver la reconstrucción de bienes!");
			send=false;
		}
