...
if(!isset($_GET['Opt'])){ // Ventana principal -> Paginación
	...
	<script type="text/javascript">
		...
		function agrega_campos(){
			...
			"<td>"+
			"<input type='text' name='items[]' id='items_"+contador+"' onKeyPress='return ACDataGrid(this.id,\"inv_bien_nacional.php\")' onKeyUp='this.value=this.value.toUpperCase()' title='Seleccione un Item'>"+
			"</td>"+
			"<td>"+
			...
			"</td>"+
			"<td>"+
			"<input type='text' name='ubicacion[]' id='ubicacion_"+contador+"' onKeyPress='return ACDataGrid(this.id,\"inv_ubicacion_nolibros_nodefectuosos.php\")' onKeyUp='this.value=this.value.toUpperCase()' title='Seleccione una Ubicación'>"+
			"</td>"+
			"<td>"+
			"<input type='text' name='ubicacion_hasta[]' id='ubicacion_hasta_"+contador+"' onKeyPress='return ACDataGrid(this.id,\"ubicacion_nolibros.php\")' onKeyUp='this.value=this.value.toUpperCase()' title='Seleccione una Ubicación Destino'>"+
			"</td>"+
			"<td>"+
				...
				<div class="table-responsive">
					<table id='tablaDetAsignacion' class="table-bordered zebra-striped">
						...
						<?php
							...
							FROM bienes_nacionales.tdetalle_asignacion da 
							...
							WHERE da.codigo_asignacion = '".$row['codigo_asignacion']."' 
							...
							while ($row = $pgsql->Respuesta($query)){
								echo "<tr id='".$con."'>
								        <td>
										<input type='text' name='items[]' id='items_".$con."' onKeyPress='return ACDataGrid(this.id,\"inv_bien_nacional.php\")' onKeyUp='this.value=this.value.toUpperCase()' title='Seleccione un Item' value='".$row['item']."'>
								        </td>
								        <td>
								        ...
								        <td>
								        <input type='text' name='ubicacion[]' id='ubicacion_".$con."' onKeyPress='return ACDataGrid(this.id,\"inv_ubicacion_nolibros_nodefectuosos.php\")' onKeyUp='this.value=this.value.toUpperCase()' title='Seleccione una Ubicación' value='".$row['ubicacion']."'>
								        </td>
								        <td>
								        <input type='text' name='ubicacion_hasta[]' id='ubicacion_hasta_".$con."' onKeyPress='return ACDataGrid(this.id,\"ubicacion_nolibros.php\")' onKeyUp='this.value=this.value.toUpperCase()' title='Seleccione una Ubicación Destino' value='".$row['ubicacion_hasta']."'>
								        </td>
								        <td>
	...
	b.nro_serial||' '||b.nombre AS item,da.cantidad,a.motivo  
	FROM bienes_nacionales.tasignacion a 
	INNER JOIN general.tpersona p ON a.cedula_persona = p.cedula_persona 
