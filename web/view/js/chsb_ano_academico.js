...
function init(){
	...
	function imprimirRegistros(){
		alertDGC(document.getElementById('Imprimir'),'./menu_principal.php?ano_academico');
	...
	function ValidarCampos(){
		var send = true;
		if($('#ano').val()==""){
			alert("¡Debe ingresar el nombre del Año Académico!");
			send = false;
		}
		...
		if(send==true){
			noty({
		        text: stringUnicode("Sí continua con el registro estará cerrando los años academicos anteriores ¿Está seguro que quiere continuar?"),
		        layout: "center",
		        type: "confirm",
		        dismissQueue: true,
		        animateOpen: {"height": "toggle"},
