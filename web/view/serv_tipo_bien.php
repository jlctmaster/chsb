		...
		<div id="paginador" class="enjoy-css">
			<div class="container">
				...
				<div id="Imprimir" style="display:none;">
					...
					<br/><br/>
					<a href="<?php echo  '../pdf/pdf_tipo_bien.php';?>" target="_blank"> <img src="images/icon-pdf.png" alt="Exportar a PDF" style="width:60px;heigth:60px;float:center;"> </a>
					&nbsp;&nbsp;
					<a href="../excel/excel_tipo_bien.php" ><img src="images/icon-excel.png" alt="Exportar a Excel" style="width:60px;heigth:60px;float:center;"></a>
	    		</div>
			</div>
		</div>
	</fieldset>
