<fieldset>
	<legend><center>Reporte: ASIGNACIÓN DE BIENES</center></legend>
	<div id="paginador" class="enjoy-css">
		<div class="container">
			<form class="form-horizontal" action="../pdf/pdf_asignacion_bienes.php"  method="post" id="form1">
...
function init(){
	$('#btnGuardar').click(function(){
		var send=true;
		if($('#fecha_inicio').val()==""){
			alert("¡Debe ingresar la fecha desde la cual desea ver las asignaciones de los bienes!");
			send=false;
		}
		
		if($('#fecha_fin').val()==""){
			alert("¡Debe ingresar la fecha hasta donde desea ver las asignaciones de los bienes!");
			send=false;
		}
